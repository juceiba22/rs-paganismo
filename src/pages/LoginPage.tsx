...
export default function LoginPage() {
  ...
  // ✅ FIX Bug 2 y 3: lógica de redirección corregida
  // Antes: `&& appUser` excluía el caso null (usuario recién registrado sin nombre)
  // Antes: el orden enviaba a /pending antes de chequear si falta el nombre
